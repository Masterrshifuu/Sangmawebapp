...
function ProfileContent() {
  ...
  return (
    <div className="p-4 flex flex-col items-center text-center border-b">
        ...
        <Tabs defaultValue="account" className="w-full text-left mt-6">
            <TabsList className="grid w-full grid-cols-2 mt-2 shrink-0">
            <TabsTrigger value="account">My Account</TabsTrigger>
            <TabsTrigger value="orders">My Orders</TabsTrigger>
            </TabsList>
            <TabsContent value="account" className="flex-1 overflow-y-auto mt-4">
            ...
            <TabsContent value="orders" className="flex-1 flex flex-col mt-4 min-h-0">
